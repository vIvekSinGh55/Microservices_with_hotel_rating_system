...
////		String temptodate = sdf1.format( sqlStartDate);
//// 		java.sql.Date sqlStartDate1 = (java.sql.Date)sdf1.parse(temptodate);
////		java.sql.Date sqlDate = sdf1.
////		System.out.println(sdf1.format( sqlStartDate));
